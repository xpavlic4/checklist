...
class ClinicServiceTests {
	...
	@Autowired
	protected CaseRepository owners;
	...
	void shouldFindOwnersByLastName() {
		Page<Case> owners = this.owners.findByNameStartingWith("Adam", pageable);
		assertThat(owners).hasSize(2);

		owners = this.owners.findByNameStartingWith("Daviss", pageable);
